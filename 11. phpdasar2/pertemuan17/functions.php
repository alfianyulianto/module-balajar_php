...
function registrasi($data){
	global $conn;
	// stripcslashes() : digunakan untuk menghilangkan karakter tertentu. Misalnya karakter /
	// stripcslashes(str)
	$username = htmlspecialchars(strtolower(stripcslashes($data["username"])));
	
	// mysqli_real_escape_string() : digunakan untuk memungkinkan user memasukan password dengan tanda kutipnya
